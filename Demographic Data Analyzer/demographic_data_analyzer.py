...
def calculate_demographic_data(print_data=True):
    ...
    num_percentage_higher=len(higher_education[higher_education.salary==">50K"]) 
    higher_education_rich =round(num_percentage_higher/len(higher_education)*100,1)
    num_percentage_lower=len(lower_education[lower_education.salary==">50K"])
    lower_education_rich =round(num_percentage_lower/len(lower_education)*100,1) 
